...
import { DelayProtection } from './DelayProtection'
  ...
  const handleSearch = () => {
    ...
    if (Object.keys(newErrors).length === 0 && isValid()) {
      ...
      trackSearch.performed('flight', {
        ...
        delay_protection: delayProtection
      })
      ...
      searchParams.set('prot', delayProtection ? '1' : '0')
      ...
      <div className="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden">
        ...
        {activeTab === 'flights' && (
          <div className="p-8 space-y-6">
            ...
            {/* Delay Protection */}
            <DelayProtection
              enabled={delayProtection}
              onToggle={setDelayProtection}
            />
